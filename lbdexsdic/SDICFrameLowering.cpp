//===-- SDICFrameLowering.cpp - SDIC Frame Information --------------------===//
//
...
const SDICFrameLowering *SDICFrameLowering::create(const SDICSubtarget &ST) {
  return llvm::createSDICSEFrameLowering(ST);
}
...
bool SDICFrameLowering::hasFP(const MachineFunction &MF) const {
